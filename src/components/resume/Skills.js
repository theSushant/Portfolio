    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">Database Management</h2>
        </div>
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">ASP.NET CORE WEB API</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Core ENTITY FRAMEWORK CORE</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
